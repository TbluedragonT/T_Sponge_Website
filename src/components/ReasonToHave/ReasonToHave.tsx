  ...
  return (
    <section className="w-full min-h-screen xl:h-[1456px] pt-[160px] relative">
      <div className="container px-5 xl:px-0">
        ...
        <div className="flex flex-col  items-center pt-[230px] justify-center">
          <h1 className="text-white luckiest text-center text-[65px] not-italic font-normal leading-[normal] z-[101] ">
            HAVE ANY QUESTIONS?
          </h1>
          <p className="text-white paytone text-center text-xl not-italic font-normal leading-[35px] z-[101] ">
