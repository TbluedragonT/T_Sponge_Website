  ...
  return (
    <section className="w-full min-h-screen xl:h-[1456px] pt-[160px] relative">
      <div className="container px-5 xl:px-0">
        <h1 className="text-white text-center luckiest text-[30px] sm:text-[40px] md:text-[50px] lg:text-[60px] xl:text-[65px] not-italic font-normal leading-[normal] ">
          REASON TO HAVE
        </h1>
        <h1 className="text-[#AF6D27] mt-[17px] luckiest text-center text-[30px] sm:text-[40px] md:text-[50px] lg:text-[60px] xl:text-[65px]  not-italic font-normal leading-[normal]">
          $SPONGE OF WALL STREET
        </h1>
        ...
        <div className="grid gap-x-[49px] mt-[100px] gap-y-4 grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
          <div className="z-[101] hover:shadow-[0px_11px_8.7px_9px_rgba(255,214,0,0.40)] xl:p-[40px] lg:p-[38px] md:p-[35px] sm:p-[28px] p-[25px] rounded-[19px] border-4 border-solid border-[#FFC700] bg-[#FFC70050] transition duration-300 transform hover:scale-105 ">
            <h1 className="text-[#F3D583] mb-[20px] xl:mb-[27px] luckiest text-center text-[20px] xl:text-[26px] not-italic font-normal leading-[normal]">
              Financial Fitness
            </h1>
          ...
          <div className="z-[101]  xl:p-[40px] lg:p-[38px] md:p-[35px] sm:p-[28px] p-[25px] hover:shadow-[0px_11px_8.7px_9px_rgba(220,3,4,0.30)] rounded-[19px] border-4 border-solid border-[#A33737]  bg-[#A3373750] transition duration-300 transform hover:scale-105">
            <h1 className="text-[#F3D583] mb-[20px] xl:mb-[27px] luckiest text-center text-[20px] xl:text-[26px] not-italic font-normal leading-[normal]">
              Peace of Mind
            </h1>
            <p className="text-white m-auto text-center text-[15px] xl:text-xl paytone not-italic font-normal leading-[35px]">
              ...
              investment. */}
              Simplified mechanics ensure a stress-free investment experience.
            </p>
          </div>

          <div className="z-[101]  xl:p-[40px] lg:p-[38px] md:p-[35px] sm:p-[28px] p-[25px] hover:shadow-[0px_11px_8.7px_9px_rgba(83,59,189,0.40)] rounded-[19px] border-4 border-solid border-[#533bbd] bg-[#533bbd50] transition duration-300 transform hover:scale-105">
            <h1 className="text-[#F3D583] mb-[20px] xl:mb-[27px] luckiest text-center text-[20px] xl:text-[26px] not-italic font-normal leading-[normal]">
              Community Support
            </h1>
            <p className="text-white m-auto text-center text-[15px] xl:text-xl paytone not-italic font-normal leading-[35px]">
              ...
              Join a supportive community, reminiscent of Bikini Bottom’s
              camaraderie.
            </p>
          </div>

          <div className="z-[101]  xl:p-[40px] lg:p-[38px] md:p-[35px] sm:p-[28px] p-[25px] hover:shadow-[0px_11px_8.7px_9px_rgba(7,142,10,0.40)] rounded-[19px] border-4 border-solid border-[#02AE3D] bg-[#02AE3D50] transition duration-300 transform hover:scale-105">
            <h1 className="text-[#F3D583] mb-[20px] xl:mb-[27px] luckiest text-center text-[20px] xl:text-[26px] not-italic font-normal leading-[normal]">
              Nostalgic Value
            </h1>
            <p className="text-white m-auto text-center text-[15px] xl:text-xl paytone not-italic font-normal leading-[35px]">
              ...
              series. */}
              Embrace the fun and nostalgia of Bikini Bottom.
            </p>
          </div>
        </div>
