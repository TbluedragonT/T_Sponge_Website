    ...
    <section id="home" className={`min-h-screen xl:h-[1080px]  relative `}>
      <div className="w-full container flex justify-center lg:pt-[300px] pt-[150px] px-5 xl:px-0 h-full">
        <div className="w-full flex flex-col items-center z-[101]">
          ...
          <p
            className={`${styles.text_border01} text-[#ffffff] text-center luckiest mt-[60px] xl:mt-[50px] sm:mt-[40px] md:mt-[40px] xl:w-[80%] w-[100%] text-[20px] sm:text-[25px] md:text-[30px] xl:text-[35px] not-italic font-normal leading-[111.425%]`}
          >
